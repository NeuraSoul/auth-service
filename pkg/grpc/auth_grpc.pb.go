...
const (
	...
	AuthService_SignUpUser_FullMethodName = "/auth.AuthService/SignUpUser"
)
...
type AuthServiceClient interface {
	...
	SignUpUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *authServiceClient) LoginUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (c *authServiceClient) SignUpUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type AuthServiceServer interface {
	...
	SignUpUser(context.Context, *UserRequest) (*UserResponse, error)
...
func (UnimplementedAuthServiceServer) LoginUser(context.Context, *UserRequest) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoginUser not implemented")
}
func (UnimplementedAuthServiceServer) SignUpUser(context.Context, *UserRequest) (*UserResponse, error) {
...
func _AuthService_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).LoginUser(ctx, req.(*UserRequest))
	}
...
func _AuthService_SignUpUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SignUpUser(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
